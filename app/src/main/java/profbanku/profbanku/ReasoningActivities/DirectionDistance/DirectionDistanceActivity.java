package profbanku.profbanku.ReasoningActivities.DirectionDistance;
...
public class DirectionDistanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_direction_distance);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_direction_distance);
        ...
        mYouTubePlayerFragment.initialize(Config.DEVELOPER_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.cuePlaylist("PLBUmbdCAjoeoDBNZ97Ctqw-bA6izfZ0pT");
            }
        ...
        final DirectionDistanceActivity.PagerAdapter adapter = new DirectionDistanceActivity.PagerAdapter
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FactsheetDirectionDistanceFragment tab1 = new FactsheetDirectionDistanceFragment();
                    return tab1;
                case 1:
                    QuestionsDirectionDistanceFragment tab2 = new QuestionsDirectionDistanceFragment();
                    return tab2;
                case 2:
                    VideoDirectionDistanceFragment tab3 = new VideoDirectionDistanceFragment();
                    return tab3;
                default:
                    return null;
            }
