...
import static profbanku.profbanku.R.id.youtubeFragmentDI;
...
public class DIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_di);
        ...
        mYouTubePlayerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(youtubeFragmentDI);
        mYouTubePlayerFragment.initialize(Config.DEVELOPER_KEY, new YouTubePlayer.OnInitializedListener() {
            @Override
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.cuePlaylist("PLBUmbdCAjoep1w9PCALpJy8Fwc1joLNnM");
            }
        ...
        final DIActivity.PagerAdapter adapter = new DIActivity.PagerAdapter
