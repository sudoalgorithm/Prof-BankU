package profbanku.profbanku.QuantitativeAptitudeActivities.Trigonometry;
...
import static profbanku.profbanku.R.id.youtubeFragmentTrigonometry;
...
public class TrigonometryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYouTubePlayerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(youtubeFragmentTrigonometry);
        ...
        final TrigonometryActivity.PagerAdapter adapter = new TrigonometryActivity.PagerAdapter
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FactsheetTrigonometryFragment tab1 = new FactsheetTrigonometryFragment();
                    return tab1;
                case 1:
                    QuestionsTrigonometryFragment tab2 = new QuestionsTrigonometryFragment();
                    return tab2;
                case 2:
                    VideosTrigonometryFragment tab3 = new VideosTrigonometryFragment();
                    return tab3;
                default:
                    return null;
            }
