package profbanku.profbanku.QuantitativeAptitudeActivities.HCFLCM;
...
public class HCFLCMActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_hcflcm);
        ...
        mYouTubePlayerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(youtubeFragmentHCFLCM);
        mYouTubePlayerFragment.initialize(Config.DEVELOPER_KEY, new YouTubePlayer.OnInitializedListener() {
            @Override
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.cuePlaylist("PLBUmbdCAjoerELS4yze_Q4mqdQ-syA7dT");
            }
        ...
        final HCFLCMActivity.PagerAdapter adapter = new HCFLCMActivity.PagerAdapter
