...
import static profbanku.profbanku.R.id.youtubeFragmentCISI;

public class CISIActiviy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cisiactiviy);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_cisiactiviy);
        ...
        mYouTubePlayerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(youtubeFragmentCISI);
        mYouTubePlayerFragment.initialize(Config.DEVELOPER_KEY, new YouTubePlayer.OnInitializedListener() {
            @Override
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.cuePlaylist("PLBUmbdCAjoeqkVuMd7lisQrlUH0P1d4-I");
            }
        ...
        final CISIActiviy.PagerAdapter adapter = new CISIActiviy.PagerAdapter
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FactsheetCISIFragment tab1 = new FactsheetCISIFragment();
                    return tab1;
                case 1:
                    QuestionsCISIFragment tab2 = new QuestionsCISIFragment();
                    return tab2;
                case 2:
                    VideosCISIFragment tab3 = new VideosCISIFragment();
                    return tab3;
                default:
                    return null;
            }
