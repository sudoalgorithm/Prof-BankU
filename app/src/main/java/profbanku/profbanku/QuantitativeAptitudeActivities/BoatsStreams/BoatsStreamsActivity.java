...
public class BoatsStreamsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boats_streams);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_boats_streams);
        ...
        mYouTubePlayerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(youtubeFragmentBoatsStreams);
        mYouTubePlayerFragment.initialize(Config.DEVELOPER_KEY, new YouTubePlayer.OnInitializedListener() {
            @Override
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.cuePlaylist("PLBUmbdCAjoepXZE36_iyCG-kxkJzc_hvD");
            }
        ...
        final BoatsStreamsActivity.PagerAdapter adapter = new BoatsStreamsActivity.PagerAdapter
