...
public class CCC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_view_ccc);
    ...
    private List<GkRowModel> fill_with_data() {
        ...
        data.add(new GkRowModel(R.drawable.page0ccc));
        data.add(new GkRowModel(R.drawable.page1ccc));
        data.add(new GkRowModel(R.drawable.page2ccc));
        data.add(new GkRowModel(R.drawable.page3ccc));
        return data;
    }
}
