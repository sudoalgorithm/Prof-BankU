...
public class ClassicalDances extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classical_dances);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_view_cd);
    ...
    private List<GkRowModel> fill_with_data() {
        ...
        data.add(new GkRowModel(R.drawable.page0cd));
